...
export default function Pricing() {
  const plans = [
    {
      name: "Nivel Iniciación",
      desc: "Nivel más básico",
      price: 0,
      isMostPop: false,
      features: ["Introducción al canto", "Introducción a los intrumentos"],
    },
    {
      name: "Nivel Bebé",
      desc: "Es un nivel de práctica",
      price: 10,
      isMostPop: true,
      features: [
        "Reconocer los instrumentos",
        "Práctica con intrumento",
        "Perfección del canto",
      ],
    },
    {
      name: "Nivel Meñique",
      ...
      isMostPop: false,
      features: [
        "Clases de canto intermedio",
        "Práctica intermedia con instrumentos",
        "Solfeo",
        "Prácticas con agrupación musical",
      ],
    },
  ];
      ...
      >
        <div className="relative max-w-xl mx-auto sm:text-center">
          ...
          <div className="mt-3 max-w-xl text-foreground/80">
            <p>Seleccione el nivel que esté cursandos.</p>
          </div>
        </div>
